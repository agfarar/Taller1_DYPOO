...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais del deportista segun el nombre");
	...
	private void ejecutarBuscarPaisPorAtleta()
	{
		
		System.out.println("\nPais del deportista");
		String nombre_atleta = input("Por favor ingrese el nombre del atleta");
		System.out.println("El nombre del país al cual representa el atleta es: "+calculadora.buscarAtletasPorPais(nombre_atleta));
